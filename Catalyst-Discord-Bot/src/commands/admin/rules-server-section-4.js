...
module.exports = {
  ...
  data: {
    description: 'Send server rules to the specified channel',
    default_permission: false,
    options: [
      {
        name: 'channel',
        description: 'The channel to send the server rules to',
  ...
  run: async ({ client, interaction }) => {
    ...
    const pathToRulesJSON = '../../../config/rules-server-section-4.json';
