...
module.exports = {
  ...
  data: {
    description: 'Send discord rules to the specified channel',
    default_permission: false,
    options: [
      {
        name: 'channel',
        description: 'The channel to send the discord rules to',
  ...
  run: async ({ client, interaction }) => {
    ...
    const pathToRulesJSON = '../../../config/rules-discord-section-0.json';
